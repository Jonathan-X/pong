//based on Meth Meth Method's tutorial
//pong in js
//ref https://www.youtube.com/watch?v=ju09womACpQ
...
class Pong {
	...
	collide(player, ball) {
		if (player.left < ball.right && player.right > ball.left &&
			...
			//speed control for when ball hits right
			ball.vel.x = -ball.vel.x * 1.2;
			const len = ball.vel.len;
			ball.vel.y += player.vel.y * .15;
			ball.vel.len = len;
		}
	}
	draw() {
